...
class FinalizarLeilaoServiceTest {
	...
	@Test
	void deveriaEnviarEmailParaLanceVencedorDoLeilao() {
		List<Leilao> leiloes = leiloes();
	...
	@Test
	void NaoDeveriaEnviarEmailParaLanceVencedorDoLeilaoEmCasoDeErroAoEncerrarOLeilao() {
		List<Leilao> leiloes = leiloes();
		Mockito.when(leilaoDao.buscarLeiloesExpirados()).thenReturn(leiloes);
		
		//Quando chamar o método salvar, independente do parametro utilizado, lançar uma exception
